...
> **v0.15.0 리뉴얼:** Three.js 입체 펫·놀이방과 이펙트, 5턴 주사위 경주, 연속 재초대, 제한 이유·남은 시간·다음 이용 시각 안내는 [입체 놀이방 상세 설계](lanpet-three-renewal.md)를 따른다. 아래 v0.14.0 및 초기 경주·초대 제한 설계보다 우선한다.

> **v0.14.0 확장:** 6종 랜덤 생성·18개 진화 형태, 원더샵 참고 스타일, 채팅방 놀이방, 경주·미니게임·무료 복권·상점·방 꾸미기는 [랜펫 놀이방 상세 설계](lanpet-world-design.md)를 따른다. 아래 초기 설계의 성장 선택·경제·화면 관련 항목보다 확장 문서가 우선한다.
